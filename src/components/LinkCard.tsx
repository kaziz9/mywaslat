...
import { ExternalLink, Heart, Bookmark, Share2, MoreVertical, Edit, Trash2 } from 'lucide-react';
...
export const LinkCard: React.FC<LinkCardProps> = ({ 
  ...
  const handleDelete = () => {
    if (window.confirm(t(language, 'deleteLinkConfirm', { title: link.title }))) {
      onDelete(link.id);
    }
  };
        ...
        {!isSelectionMode && (
          <div className="flex items-center space-x-1 sm:space-x-2 flex-shrink-0">
            ...
            <button
              ...
              className="p-1 sm:p-1.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200 hover:scale-110"
            >
          ...
          <div className="flex items-center justify-between mt-1 sm:mt-2">
            ...
            {!isSelectionMode && (
              <div className="flex items-center space-x-0.5 sm:space-x-1">
                ...
                <button
                  onClick={handleOpenLink}
                  className="p-0.5 sm:p-1 bg-blue-600 text-white rounded hover:bg-blue-700 transition-all duration-200 hover:scale-110"
                >
